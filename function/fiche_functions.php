...
{
public static function afficherFicheAdmin(array $data)
{
    ?>
...
public static function afficherFicheAbonne(array $data)
{
?>
<link rel="stylesheet" href="style/mystyle.css">
...
<div style="margin : 2%" class="container">
    ...
    <table>
        ...
        <?php
        foreach (ficheAbonne::getRecommandationsParCatégorie($_SESSION['id']) as $aBook) {
            echo '<tr><td>' . $aBook[1] . '</td>';
        }
        ?>
    </table>
    ...
    <table>
        ...
        <?php
        foreach (ficheAbonne::livresLesPlusEmpruntes($_SESSION['id']) as $aBook) {
            echo '<tr><td>' . $aBook[0] . '</td>';
            echo '<td>' . $aBook[1] . '</td></tr>';
        }
        }
